...
A = mdl.find_nodes_by_location(Point(0, 0, -h), distance=1)
B = mdl.find_nodes_by_location(Point(lx, 0, -h), distance=1)
C = mdl.find_nodes_by_location(Point(lx, ly, -h), distance=1)
D = mdl.find_nodes_by_location(Point(0, ly, -h), distance=1)
